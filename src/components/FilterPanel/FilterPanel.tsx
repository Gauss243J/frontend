...
export const FilterPanel: React.FC<{ onChange: (c: FilterCriteria) => void }> = ({ onChange }) => {
  ...
  const handleReset = () => {
    setText(''); setColor('#0ea5e9'); setFile(null); setObjects([]); setWords('')
    setIntervalFrom('00:00:00'); setIntervalTo('00:00:00');
    setEnableText(true); setEnableColor(false); setEnableFile(false); setEnableObjects(false); setEnableWords(false); setEnableInterval(false)
  }
